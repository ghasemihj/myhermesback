...
**تاریخ:** 1405/05/14 — 2026-08-05
**ساعت تولید:** 11:00 IRST
...
|---|---|---|---|---|---|---|---|
| Spot — myTrades | ✅ | 200 | 0 | 37 | 19 | ✅ | — |
| Spot — allOrders | ✅ | 200 | 0 | 23 | 19 | ✅ | — |
| Spot — openOrders | ✅ | 200 | 0 | 1 | 19 | ✅ | — |
| Futures — history_orders | ✅ | 200 | 0 | 4 | 1 | ✅ | — |
| Futures — order_deals | ✅ | 200 | 0 | 5 | 1 | ✅ | — |

## ⏰ زمان‌ها

- Collection started at: **2026-08-05T11:00:18.297458+03:30**
- Collection completed at: **2026-08-05T11:00:28.380788+03:30**
- Report generated at: **2026-08-05T11:00:30.853092+03:30**
...
- رکوردهای جدید (پس از حذف تکرار): **4**
  - Completed: 4

### تاریخچه معاملات و سود/زیان

- رکوردهای دریافتی از API: **5**
- رکوردهای جدید (پس از حذف تکرار): **1**
- نمادها: GRIFFAIN_USDT
- سود/زیان ثبت‌شده: داده کافی نیست
- کارمزد ثبت‌شده: 0.0139

...
گزارش تولید و ذخیره شد. خلاصه وضعیت:

**وضعیت کلی: 🟠 نارنجی**

رویدادهای کلیدی ۲۴ ساعت گذشته:

1. **🔴 حمله موشکی به نفتکش ادنوک (امارات) در تنگه هرمز** — تأییدشده توسط UAE + UKMTO + Reuters. ADNOC اعلام کرده ۳ کشتی در یک هفته هدف حمله قرار گرفته‌اند.

2. **🔴 UKMTO: هدف قرار گرفتن شناور در ۱۸ مایلی خصب عمان** — تأییدشده. پرتابه ناشناس آتش‌سوزی ایجاد کرد.

3. **🟠 ذوالقدر: ۶ شرط ایران برای بازگشایی تنگه هرمز** — توقف حملات، غرامت، لغو تحریم‌ها، آزادسازی دارایی‌ها، خروج نیروهای آمریکایی.

4. **🟡 عراقچی: توافق مسیر موقت با عمان «بسیار نزدیک»** — اما فقط عبور موقت، نه بازگشایی کامل.

5. **🟡 توافق مکه:** پاکستان-ترکیه-عربستان پیمان دفاعی مشترک امضا کردند.

6. **⚪ ادعای حوثی: حمله به آرامکو جیزان** — تأیید نشده (عربستان اظهارنظر نکرده).

7. **🟡 مذاکرات آمریکا-ایران:** ونس: «وسط بازی هستیم». باسنت: احتمال آتش‌بس ۳۰-۶۰ روزه. اما شروط جدید ایران فاصله را زیاد کرده.

📁 ذخیره شد: `/data/.hermes/reports/gulf-kharg-watch/latest.md` و `gulf-kharg-watch-2026-08-09-1130-IRST.md`
💾 فضای آزاد: ۲۷۳ MB (۳۶٪) — ✅
